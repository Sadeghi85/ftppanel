...
{{ Form::open(array('route' => array('users.update', $user->id), 'method' => 'PUT', 'class' => 'form-horizontal', 'id' => 'form', 'autocomplete' => 'off')) }}
		...
		<div class="panel-body collapse in">
			...
			<fieldset>
				...
				<div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
					{{ Form::label('username', Lang::get('users/messages.edit.username').' *',
				...
				<div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
					{{ Form::label('password', Lang::get('users/messages.edit.password'),
					array('class' => 'control-label col-md-12')) }}
					<div class="col-md-24">
				...
				<div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
					{{ Form::label('password_confirmation', Lang::get('users/messages.edit.password_confirmation'),
					array('class' => 'control-label col-md-12')) }}
					<div class="col-md-24">
				...
				<div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
					{{ Form::label('first_name', Lang::get('users/messages.edit.first_name'),
					array('class' => 'control-label col-md-12')) }}
					<div class="col-md-24">
				...
				<div class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
					{{ Form::label('last_name', Lang::get('users/messages.edit.last_name'),
					array('class' => 'control-label col-md-12')) }}
					<div class="col-md-24">
				...
				<div class="form-group {{ $errors->has('activated') ? 'has-error' : '' }}">
					{{ Form::label('activated', Lang::get('users/messages.edit.activated'),
					array('class' => 'control-label col-md-12')) }}
					<div class="col-md-12">
		...
		<div class="panel-body collapse in">
			...
			<fieldset>
				...
				<div class="form-group {{ $errors->has('groups') ? 'has-error' : '' }}">
					{{ Form::label('users', Lang::get('users/messages.edit.groups'),
					array('class' => 'control-label col-md-12')) }}
					<div class="col-md-24">
