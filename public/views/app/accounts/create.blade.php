		...
		<div class="panel-body collapse in">
			...
			<fieldset>
				...
				<div class="form-group {{ $errors->has('http') ? 'has-error' : '' }}">
					{{ Form::label('http', Lang::get('accounts/messages.create.http'),
					array('class' => 'control-label col-md-12')) }}
					<div class="col-md-12">
						{{ Form::select('http', array('0'=>Lang::get('general.no'),'1'=>Lang::get('general.yes')), Input::old('http', 1), array('class'=>'form-control')) }}
					</div>
					<div class="col-md-6">
						<label class="control-label"></label>
					</div>
				...
				<div class="form-group {{ $errors->has('textfile') ? 'has-error' : '' }}">
					{{ Form::label('textfile', Lang::get('accounts/messages.create.textfile'),
					array('class' => 'control-label col-md-12')) }}
					<div class="col-md-12">
						{{ Form::select('textfile', array('0'=>Lang::get('general.no'),'1'=>Lang::get('general.yes')), Input::old('textfile', 1), array('class'=>'form-control')) }}
					</div>
					<div class="col-md-6">
						<label class="control-label"></label>
					</div>
